...
class M_dashboard extends CI_Model
{
    ...
    public function _update_kec($id)
    {
        $where = array(
            "id_kecamatan" => $id
        );
    ...
    // update kecamatan
    public function _get_kecamatan2()
    {
        $data = $this->db->query("SELECT * FROM tb_kecamatan_baru WHERE updated='0' LIMIT 1");

        return $data;
    }

    public function _update_kec2($id)
    {
        $where = array(
            "id_kecamatan" => $id
        );
