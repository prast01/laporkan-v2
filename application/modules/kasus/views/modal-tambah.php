        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- form start -->
                        <form class="form-horizontal" method="post" action="<?php echo site_url('../kasus/add'); ?>" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <label for="inputEmail3" class="col-sm-2 col-form-label">Status Pasien</label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-4">
                                        <input type="number" class="form-control" name="umur" placeholder="Umur" required maxlength="2">
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div id="f_akhir" style="display: none;" class="col-6">
                                        <div class="row">
                                            <label for="inputEmail3" class="col-sm-4 col-form-label">Faskes</label>
                                            <div class="col-sm-8">
                                    ...
                                    <div id="kas" style="display: none;" class="col-6">
                                        <div class="row">
