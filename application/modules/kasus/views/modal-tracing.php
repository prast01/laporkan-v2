                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <h7 class="text-muted">Atau,Klik tambah Kontak Erat Baru jika tidak menemukan nama individu yang di maksud</h7>
                                </div>
                                <div class="col-md-12">
                                    <button class="btn btn-success" id="btn-show-form-otg">TAMBAH KONTAK ERAT BARU <i class="fa fa-plus"></i></button>
                                </div>
                            </div>
                            <hr>
                            <?php
                        ...
                        <!-- /.card-body -->
                        <form class="form-horizontal" id="add-tracing" method="post" action="<?php echo site_url('../kasus/add_tracing'); ?>" enctype="multipart/form-data">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#id_name').select2({
            ajax: {
                url: "<?php echo base_url('kasus/get_data_pasien') ?>",
                dataType: 'json',
                delay: 500,
            ...
            placeholder: 'Masukkan Nama Pasien Yang Pernah Di Entri',
        ...
        async function isPersonExist() {
            ...
            return await $.ajax({
                ...
                success: function(data) {
                    ...
                    if (dt.is_exist == '1') {
                        alert("Duplikat Data atau cek by Name di Form Pencarian");
                    } else {
                        console.log({
                            "is_exist": "0"
                        });
        ...
        function drawTableTracing() {
            ...
            dataTracing.forEach(item => {
                ...
                html += '<td>' + addRemoveTracing(item.id, item.row_num, item.is_form_input) + '</td>';
                html += '</tr>';
            });
            $('#body-list').html(html);
        ...
        function deleteTracing(id, rowNum) {
            var id_lap = $('#id_laporan').val();
            $.ajax({
                url: "<?php echo base_url('kasus/delete_tracing/'); ?>" + id_lap + "/" + id,
                success: function(data) {
                    spliceTracing(rowNum);
                    drawTableTracing();
                }
