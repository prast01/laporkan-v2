...
class Services extends MY_Controller {
    ...
    public function getHarian3()
    {
        ...
        //     // $odp = $odp + $model->getODP("komulatif2", $tgl);
    ...
    public function dataTracing($id)
    {
        ...
        foreach ($data as $key) {
            if ($key->status != '4') {
                ...
                $hsl[$no]['id_laporan'] = $dt->id_laporan;
            } else {
                $dt = $model->get_tracing_otg($key->kontak);
                $hsl[$no]['id_laporan'] = $dt->id_otg;
            }
