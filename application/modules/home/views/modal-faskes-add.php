						...
						<div class="row">
							<div class="col-12">
								<div class="card">
									<div class="card-body">
										<!-- form start -->
										<form class="form-horizontal" method="post" action="<?php echo site_url('../home/add_faskes'); ?>" enctype="multipart/form-data">
											<div class="card-body">
												<div class="form-group row">
													<label for="inputEmail3" class="col-sm-2 col-form-label">Nama Faskes</label>
													<div class="col-sm-4">
														<input type="text" class="form-control" name="nama_faskes" placeholder="Nama Faskes" required>
													</div>
