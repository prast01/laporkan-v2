												...
												<div class="form-group row">
													...
													<div class="col-sm-4">
														<select name="nakes" class="form-control select2" style="width: 100%" required>
															<option <?php if($laporan->nakes == "0"){ echo "selected"; } ?> value="0" disabled>Pilih</option>
												...
												<div class="form-group row">
													...
													<div class="col-sm-4">
														<select name="rdt" class="form-control select2" style="width: 100%">
															<option <?php if($laporan->rdt == "0"){ echo "selected"; } ?> value="0" disabled>Pilih</option>
													...
													<div class="col-sm-4">
														<select name="swab" class="form-control select2" style="width: 100%">
															<option <?php if($laporan->swab == "0"){ echo "selected"; } ?> value="0" disabled>Pilih</option>
