												...
												<div class="form-group row">
													...
													<div class="col-sm-4">
														<select name="id_laporan" id="id_laporan" class="form-control select2" style="width: 100%" required>
															<option <?php if($covid3->id_laporan == $covid3->id_laporan){ echo "selected"; } ?> value="<?php echo $covid3->id_laporan; ?>"><?php echo $covid3->nama." || ".$covid3->alamat; ?></option>
															<option disabled>Pilih</option>
															<?php
																foreach ($covid2 as $key) {
															?>
															<option <?php if($pasien_karantina->id_laporan == $key->id_laporan){ echo "selected"; } ?> value="<?php echo $key->id_laporan; ?>"><?php echo $key->nama." || ".$key->alamat; ?></option>
															<?php
																}
															?>
														</select>
												...
												<div class="form-group row">
													...
													<div class="col-sm-4">
														<select name="id_karantina" id="id_karantina" class="form-control select2" style="width: 100%" required>
															...
															?>
															<option <?php if($pasien_karantina->id_karantina == $key->id_karantina){ echo "selected"; } ?> value="<?php echo $key->id_karantina; ?>"><?php echo $key->karantina; ?></option>
															<?php
																}
															?>
														</select>
