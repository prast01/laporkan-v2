								...
								<div class="form-group row">
									...
									<div class="col-sm-6">
										<select name="id_laporan" id="id_laporan" class="form-control select2" style="width: 100%" required>
											...
											?>
												<option value="<?php echo $key->id_laporan; ?>"><?php echo $key->nik . " || " . $key->nama . " || " . $key->alamat_domisili; ?></option>
											<?php
											}
											?>
										</select>
								...
								<div class="form-group row">
									...
									<div class="col-sm-4">
										<select name="id_karantina" id="id_karantina" class="form-control select2" style="width: 100%" required>
											...
											?>
												<option value="<?php echo $key->id_rumah_isolasi; ?>"><?php echo $key->nama_rumah_isolasi; ?></option>
											<?php
											}
											?>
										</select>
