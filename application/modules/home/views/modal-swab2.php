						...
						<div class="row">
							<div class="col-12">
								<div class="card">
									...
									<form class="form-horizontal" id="add-swab" method="post" action="<?php echo site_url('../swab/add_swab_kirim'); ?>" enctype="multipart/form-data">
										<!-- form start -->
										<div class="card-body">
											...
											<div class="form-group row">
												...
												<div class="col-sm-4">
													<select name="id_lab" class="form-control select2" style="width: 100%" required>
